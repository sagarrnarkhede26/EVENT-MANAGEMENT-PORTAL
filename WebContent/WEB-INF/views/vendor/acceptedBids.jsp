			...
			<div class="wrap-table100">
				<div class="table100 ver1 m-b-110">
						...
						<table>
							<thead>
								<tr class="row100 head">
								 <th class="cell100 column3">Event Title</th>
									<th class="cell100 column3">City</th>
									<th class="cell100 column3">Date</th>
									<th class="cell100 column3">Offered Bid Amount</th>
									<th class="cell100 column3">Cover Letter</th>
					...
					<div class="table100-body js-pscroll">
						<table>
							<tbody>
							  <c:forEach var="p" items="${requestScope.accepted_bids}">
								<tr class="row100 body">
								
          
									<td class="cell100 column3">${p.event.title}</td>
									<td class="cell100 column3">${p.event.eventCity}</td>
									<td class="cell100 column3">${p.event.eventDate}</td>
									<td class="cell100 column3">${p.bidAmount }</td>
									<td class="cell100 column3">${p.bidDesc}</td>
										<td class="cell100 column3">Accepted</td>
